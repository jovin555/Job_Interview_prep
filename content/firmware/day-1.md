...
## Q5: Walk me through how you would structure the firmware for a battery-powered medical device that needs to run for 7 days continuously, like the Project X.

**Answer:** For the **Project X**, which required 7 days of continuous use on a Li-ion battery, the firmware architecture was built around aggressive power management. The structure was:
